...
residential_price_seas_diff <- diff(ts_electricity_price[,"Residential"],lag=12, differences=1) #lag=1 usually for non-seasonal
...
print(SARIMA_manual) #drift is false since I'm differencing my series twice
