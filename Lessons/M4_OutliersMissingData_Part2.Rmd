...
decompose_wind <- decompose(clean_wind_data,"additive")
plot(decompose_wind )

par(mfrow= c(1,2))
decompose_wind_add <- decompose(clean_wind_data,"additive")
plot(decompose_wind_add )

decompose_wind_mult <- decompose(clean_wind_data,"multiplicative")
...
df <- data.frame(Date = wind_data$DATE, wind_random, wind_seasonal, wind_trend)
