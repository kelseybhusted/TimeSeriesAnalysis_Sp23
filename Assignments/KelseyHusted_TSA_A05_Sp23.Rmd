...
> Answer: I would assume that maybe having data over a longer period of time is generally better in practice with potentially higher statistical significance. Even so, without the historical data, one can still observe the upward trend and seasonality in the data.
