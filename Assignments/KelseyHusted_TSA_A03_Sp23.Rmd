...
par(mfrow = c(1,3))
#Total Biomass Energy Production
Biomass_detrend <- residuals(biomass_linear_trend)
plot(Biomass_detrend, type="l", main = "Detrended Biomass Prod.", 
         col = "cadetblue",
         ylab = "Energy Biomass Prod.")
#Total Renewable Energy Production
RenewableEnergy_detrend <- residuals(renewable_linear_trend)
plot(RenewableEnergy_detrend, type = "l", main = "Detrended Renewable Energy Prod.",
         col = "chartreuse4",
         ylab = "Renewable Energy Production")
#Hydroelectric Power Consumption
hydroelectric_detrend <- residuals(hydro_linear_trend)
